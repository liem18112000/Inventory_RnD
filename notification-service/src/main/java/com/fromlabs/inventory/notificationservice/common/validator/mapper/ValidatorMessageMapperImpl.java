...
import com.fromlabs.inventory.notificationservice.common.helper.FLStringUtils;

import java.util.HashMap;
import java.util.Map;
import java.util.Set;

import static com.fromlabs.inventory.notificationservice.common.validator.CriteriaImpl.CRITERIA.*;
