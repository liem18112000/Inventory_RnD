...
import static com.fromlabs.inventory.notificationservice.common.exception.handler.RequestExceptionHandler.*;
...
public class WebTemplateProcessWithCheckBeforeAfter extends WebTemplateProcess implements WebCheckBeforeAfterTemplateProcess {
     ...
     * @see com.fromlabs.inventory.notificationservice.common.exception.FailValidateException
     * @see Boolean
     */
