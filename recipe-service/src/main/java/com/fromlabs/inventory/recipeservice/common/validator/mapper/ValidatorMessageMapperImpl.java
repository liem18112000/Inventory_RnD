...
package com.fromlabs.inventory.recipeservice.common.validator.mapper;


import com.fromlabs.inventory.recipeservice.common.helper.FLStringUtils;

import java.util.HashMap;
import java.util.Map;
import java.util.Set;

import static com.fromlabs.inventory.recipeservice.common.validator.CriteriaImpl.CRITERIA.*;
...
public class ValidatorMessageMapperImpl implements ValidatorMessageMapper {
    ...
    protected final String DEFAULT_VALIDATE_MESSAGE = "%s does not pass utility";
