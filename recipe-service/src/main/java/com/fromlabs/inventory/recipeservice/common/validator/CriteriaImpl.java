...
import com.fromlabs.inventory.recipeservice.common.validator.mapper.ValidatorMessageMapper;
import com.fromlabs.inventory.recipeservice.common.validator.mapper.ValidatorMessageMapperImpl;
...
public class CriteriaImpl implements Criteria<String>{
    ...
    /**
     * Overall utility check for all criteria of a specific object
