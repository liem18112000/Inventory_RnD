...
import com.fromlabs.inventory.recipeservice.common.exception.NotImplementException;
import com.fromlabs.inventory.recipeservice.common.exception.ObjectNotFoundException;
import com.fromlabs.inventory.recipeservice.common.exception.RequestNotFoundException;
...
public class RequestExceptionHandler implements ExceptionHandler<ResponseEntity<?>> {
    ...
    protected ExceptionHandlerConfiguration configByDefault() {
        this.configuration = new RequestExceptionHandlerConfiguration()
            .status(HttpStatus.INTERNAL_SERVER_ERROR, FailTransactionException.class.getName())
