 ...
 */
export class RecipeGroupForm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            visible: false,
            errors: {},
            editTitle: 'Edit Recipe Group',
            createTitle: 'New Recipe Group'
        }
    ...
    /**
     * Form action is activated when the form need to save or update recipe group information
    ...
    validateSubmit(callback) {
        this.setState({
            ...this.state,
            errors: {
                name: !this.requireField(this.state.data.name) ? "Recipe category name is required" : null,
                code: !this.requireField(this.state.data.code) ? "Recipe category code is required" : null,
            }
        }, callback)
    }
