...
/**
 * <h1>Ingredient Referenced Extend Entity</h1>
 *
 * <h2>Brief Information</h2>
 * <p>Ingredient Referenced Extend Entity is derived from the Ingredient Referenced Base Entity</p>
 ...
 * @see IngredientReferencedBaseEntity
 * @see Serializable
 */
@MappedSuperclass
@Getter
...
public class IngredientReferencedExtendEntity<ID extends Serializable> extends IngredientReferencedBaseEntity<ID> {
    ...
    public boolean equals(Object o) {
        ...
        IngredientReferencedExtendEntity<?> that = (IngredientReferencedExtendEntity<?>) o;
